...
def get_customer_by_chat(chat_id):
    return frappe.db.get_value("Telegram User", {"telegram_user_id": chat_id}, "customer")
...
def telegram_webhook():
    ...
    elif msg.get("text") == "/bukti_transfer":
    ...
    # ========== 4. Pesan selain perintah ==========
        ...
        reply_text = "Perintah tidak dikenali. Gunakan /cek_tagihan atau /bukti_transfer"
